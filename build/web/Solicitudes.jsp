<%-- 
    ...
    Created on : 11/11/2020, 01:33:28 AM
    Author     : betza
--%>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-primary bg-dark">
                    ...
                    <div class="dropdown-divider"> </div>
                        <a style="margin-right: 12px; border: none" href="Inicio.jsp" class="btn btn-primary">Cerrar Sesión<i class="fa fa-ban" aria-hidden="true"></i></a>
            ...
            ResultSet rs=null;
                    ...
                    "uz12ygmfpezutoigizzh", "UiMW2WrP7I0D0TQRPD3I");
                     ...
                     <tr>
                        ...
                        <td><a href="Comercio.jsp?id=<%= rs.getString(1)%>&tel=<%= rs.getString(9)%>"> Más información...</a></td>
